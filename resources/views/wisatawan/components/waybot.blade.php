        ...
        <div class="waybot-messages" x-ref="messagesContainer">
            ...
            <template x-if="messages.length === 0">
                <div class="waybot-welcome">
                    ...
                    <p class="waybot-welcome-title">Halo! Aku Waybot</p>
                    <p class="waybot-welcome-sub">Asisten wisata pintarmu di Batam. Tanya apa aja — rekomendasi tempat, info harga, atau rute terbaik!</p>
                    <div class="waybot-suggestions">
                        <button @click="sendSuggestion('Rekomendasikan destinasi wisata di Batam')" class="waybot-suggestion-chip">
                            🏝️ Rekomendasi wisata
                        </button>
                        <button @click="sendSuggestion('Destinasi apa yang cocok untuk keluarga?')" class="waybot-suggestion-chip">
                            👨‍👩‍👧 Wisata keluarga
                        </button>
                        <button @click="sendSuggestion('Pantai terbaik di Batam apa?')" class="waybot-suggestion-chip">
                            🌊 Pantai terbaik
                        </button>
                        <button @click="sendSuggestion('Kuliner enak di Batam')" class="waybot-suggestion-chip">
