<footer class="bg-[#9ECCDB] border-t text-white">
    <div class="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between">

        {{-- BRAND + KONTAK --}}
        <div class="flex flex-col items-start">
            <div class="flex items-center gap-3 mb-3">
                <img src="{{ asset('assets/logo/logoo.png') }}" class="h-10 w-auto" alt="WayWay">
                <h3 class="font-bold text-[#415c7f] text-lg"><span class="font-bold text-transparent bg-clip-text bg-gradient-to-br from-[#c6c4c9] via-[#415c7f] to-[#c6c4c9]"> WayWay </span>
                </h3>
            </div>
